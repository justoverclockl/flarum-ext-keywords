...
var GlossaryPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.oncreate = function oncreate(vnode) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.setTitle(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarum-ext-keywords.forum.pagetitle'));
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.setTitleCount(0);
  };

  _proto.view = function view() {
    var mappings = JSON.parse(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('AdDef')); // Funzione ricerca live
    ...
    return m('.IndexPage', [flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.hero(), m('.container', m('.sideNavContainer', [m('nav.IndexPage-nav.sideNav', m('ul', flarum_common_helpers_listItems__WEBPACK_IMPORTED_MODULE_4___default()(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.sidebarItems().toArray()))), m('.IndexPage-results.sideNavOffset', m('h1', {
      className: 'glostitle'
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarum-ext-keywords.forum.pagetitle')), m('div', {
      className: 'rowgl'
    }, [m('div', {
      className: 'columngl'
    }, m('div', {
      ...
      className: 'tagline'
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarum-ext-keywords.forum.tagline')))), m('div', {
      className: 'columngl'
    }, m('div', {
      className: 'rightdiv'
    }, m('form', {
      ...
      id: 'filter',
      type: 'text',
      placeholder: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarum-ext-keywords.forum.searchtext')
    })])))]), m('div', {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var post = this.attrs.post; // Lettura dell'input form in formato JSON

  var mappings = JSON.parse(flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('AdDef'));
  if (mappings === {}) return;
  if (Object.keys(mappings).length === 0) return; // filtro per evitare il parsing doppio delle parole
  ...
  Object.keys(mappings).filter(function (w) {
    ...
    _this.attrs.post.data.attributes.contentHtml = post.contentHtml().replace(regex, function (match) {
